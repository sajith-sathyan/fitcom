...
import UsernameInput from "../../component/input/FirstName/FirstName";
...
import { api, googleAuth, userService } from '../../api/authApi'
    ...
    const handleSubmission = async (e) => {
        ...
        try {
            ...
            if (submissionResponse.data) {
                const { token, email,userId } = submissionResponse.data;
            ...
            setAlertMessage({ type: "error", message: error.response?.data?.message || "An unexpected error occurred. Please try again." });
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="container">
            <div className="register-card">
                ...
                <form className="register-form" onSubmit={handleSubmission}>
                    ...
                    <button class="btn-165" onClick={googleLogin} >
